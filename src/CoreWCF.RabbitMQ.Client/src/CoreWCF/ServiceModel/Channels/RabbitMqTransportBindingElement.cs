...
{
    public class RabbitMqTransportBindingElement : System.ServiceModel.Channels.TransportBindingElement
    {
        ...
        public override IChannelFactory<TChannel> BuildChannelFactory<TChannel>(System.ServiceModel.Channels.BindingContext context)
        {
            if (context == null)
            {
                throw new ArgumentNullException(nameof(context));
        ...
        {
            return typeof(TChannel) == typeof(System.ServiceModel.Channels.IOutputChannel);
        }

        public RabbitMqConnectionSettings GetConnectionSettings()
        {
            return RabbitMqConnectionSettings.FromUri(BaseAddress, Credentials, SslOption, VirtualHost);
        }
    }
}
